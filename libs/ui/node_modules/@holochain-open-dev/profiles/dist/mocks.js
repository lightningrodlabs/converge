...
export class ProfilesZomeMock extends ZomeMock {
    ...
    search_agents(nickname_filter) {
        return Array.from(pickBy(this.agentsProfiles, (profile) => decodeEntry(profile).nickname
            .toLowerCase()
            .startsWith(nickname_filter.toLowerCase().slice(0, 3))).keys());
    }
