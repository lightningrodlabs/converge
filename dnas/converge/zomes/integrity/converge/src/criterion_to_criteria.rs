use hdi::prelude::*;
pub fn validate_create_link_criterion_to_criteria(
    _action: CreateLink,
...
pub fn validate_delete_link_criterion_to_criteria(
    _action: DeleteLink,
    ...
    Ok(
        ValidateCallbackResult::Invalid(
            String::from("CriterionToCriteria links cannot be deleted"),
        ),
    )
}
